...
**AI 作文评分偏差基准测试框架 — 量化 AI 评分系统与参考评分之间的偏差。**

---

## 项目简介

GradeLens 是一个**可复用的开源基准测试框架**，用于衡量 AI 作文评分系统（iWrite / 批改网 PIGAI 等）的评分偏差。
...
> **重要声明**：本项目附带的 48 篇测试作文由 AI 生成，配套的参考评分同样由 AI 模拟生成，**仅供框架演示和参考，不代表真实人工评分**。
>
...
| over_optimized | 过度优化 | -16.0（低估） |
| chinese_writing | 中文写作 | +5.0（高估） |
...
```bash
# 克隆仓库
git clone https://github.com/Risaner/gradelens.git
cd gradelens
